...
class B_SES_config_page(B_SES_config_pageTemplate):
    ...
    def fill_labels(self, selected_option):
        ...
        option_data = data[selected_option]
        ...
        for label in labels:
            value = option_data.get(label, "N/A")
            label_obj = getattr(self.C_Dashboard_page, label)
    ...
    def Sustainability_Dropdown_change(self, **event_args):
        ...
        self.fill_labels(self.C_Dashboard_page, selected_option)
